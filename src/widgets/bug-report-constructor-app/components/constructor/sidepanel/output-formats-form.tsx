...
const CustomFormatsEditor: React.FC<{
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="rounded-md border border-[color-mix(in_srgb,var(--ring-main-color)_40%,var(--ring-borders-color))] bg-[color-mix(in_srgb,var(--ring-main-color)_8%,transparent)] px-3 py-2 text-[13px] text-[var(--ring-text-color)]">
          ...
          {outputFormats.formats.map(f => (
            ...
            >
              ...
              <textarea
                ...
                className="w-full resize-y rounded-md border border-[var(--ring-borders-color)] bg-transparent px-3 py-2 text-[13px] leading-5 outline-none focus:ring-2 focus:ring-[var(--ring-border-accent-color)]"
              />
            </div>
          ))}
        </div>
